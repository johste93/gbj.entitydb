...
{
	public class AssetReferenceComputeShaderHolder : AssetReferenceHolder
	{
		public AssetReferenceComputeShader AssetReference;
		public override AssetReference GetAssetReference() => AssetReference;
		public override void NewAssetReference(string guid) => AssetReference = new AssetReferenceComputeShader(guid);
